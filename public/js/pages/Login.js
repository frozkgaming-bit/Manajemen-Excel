                    ...
                    <form action="#" class="space-y-5" method="POST" id="loginForm">
                        ...
                        <div data-purpose="input-group-password">
                            ...
                            <div class="relative rounded-lg shadow-sm">
                                ...
                                <button aria-label="Tampilkan password" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600 transition-colors focus:outline-none" id="toggle-password-btn" type="button">
